      ...
      <main className="flex-grow">
        <section className="bg-gradient-to-b from-gray-100 to-white">
          <div className="max-w-6xl px-4 mx-auto sm:px-6">
            <div className="gap-12 pt-32 pb-12 md:pt-40 md:pb-20">
              {/* Page header */}
              <div className="max-w-3xl pb-12 mx-auto md:pb-20">
                <h1 className="text-center h1 ">Welcome to Bumblebee.</h1>
              </div>

              {/* Form */}
              <div className=" min-w-[50%] max-w-sm mx-auto">
